        ...
        <section className="text-gray-400">
            ...
            >
                <div className="mx-auto max-w-3xl text-center">
                    <h1
                        className="bg-gradient-to-r from-cyan-500 via-sky-700 to-cyan-900 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"
                    >
                        Sanchita Devi
                    ...
                    <div className='flex justify-center items-center space-x-5 mt-10 text-xl font-bold text-sky-700'>
